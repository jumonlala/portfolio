...
cardList.push(new Card('blogs', 'From 2014 to 2025: How the U.S. Bird Flu Crisis Has Evolved', "My article examines the 2025 bird flu outbreak in the United States by comparing it to the 2014-2015 outbreak, exploring how patterns of transmission, government response, and economic impact differ.", null, null, 'resources/eng310_final.pdf'))
cardList.push(new Card('blogs', 'Mechanism Description of the Marble Machine', "My teammates and I describe the construction and function of the marble machine, a physics demonstration designed to teach concepts of mass, momentum, and inertia through sorting marbles by weight.", null, null, 'resources/eng310_mechanism.pdf'))
cardList.push(new Card('blogs', 'Between Stereotype and Self: The Role of the Model Minority Myth in Shaping Academic Decisions Among Asian American Students', "I examine how the model minority myth influences Asian American students' academic decisions, particularly in STEM fields, exploring its intersections with historical exclusion, systemic discrimination, and societal expectations.", null, null, 'resources/soc3030_final.pdf'))
cardList.push(new Card('blogs', 'Vaccine Hesitancy Among Evangelicals Through the Lens of Secularization Theorists', "I analyze vaccine hesitancy among White Evangelicals through the lens of secularization theories, exploring how religious authority, political engagement, and the biblical worldview shape resistance to public health interventions.", null, null, 'resources/soc329_final.pdf'))
cardList.push(new Card('blogs', 'Church Planting and Religious Marketplace: A Sociological Examination of Secularization, Pluralism, and Strategy', "I analyze the sociological dynamics of church planting, examining how theories of secularization, religious pluralism, and rational choice influence success and failure in engaging unchurched populations.", null, null, 'https://github.com/jumonlala/church_planting'))
